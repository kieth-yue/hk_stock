...
4.  唔好硬湊數：如果冇足夠消息催化，板塊/標的/避開板塊有幾多寫幾多，唔好為了夠數推冇消息的票

【內容硬要求（唔符合就唔合格）】
1.  有加息/減息/降準/重大行業政策呢類大消息，必須放最前面的「重大突發消息」，直接講清楚對銀行、地產、科技等利率敏感板塊的影響
2.  板塊催化必須講具體消息：唔好淨係寫「資金關注」「有消息」，要講清楚是什麼消息
3.  避開板塊必須講具體原因：唔好淨係寫「注意風險」，要講清楚為什麼唔好碰（例如「內房板塊：碧桂園債務展期失敗，資金流出」）
4.  盯盤標的必須俾明確觀察條件：唔好淨係寫股票名，要講清楚「突破XX元並放量先追」「回調10天線低吸」呢類具體動作
5.  開盤守則必須結合當日市況：嚴禁使用「高開不追、低開不割」呢類日日都啱用的通用廢話，要結合今日的情緒同板塊俾具體建議
6.  風險提示必須講具體風險：唔好寫空話，要講清楚是什麼風險
...
3. 🚫 今日避開板塊
最多2個，每個講：【板塊】具體避開原因，冇就寫「今日冇明確需要避開的板塊」
